...
import com.lixiaohui8636.widget.BaseSwipeRecyclerViewListener;
import com.lixiaohui8636.widget.SwipeRecyclerView;
...
public class SwipeListViewExampleActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        swipeListView.setSwipeListViewListener(new BaseSwipeRecyclerViewListener() {
            @Override
